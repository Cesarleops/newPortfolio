...
export  const myProjects: {
    ...
    AdvancedSignUp: {
      ...
      image: ["src/assets/firstSign.png", "src/assets/secondSign.png", "src/assets/thirdSign.png","src/assets/fourthSign.png"],
    ...
    Umoob: {
      ...
      image: ['src/assets/umoobOne.png','src/assets/umoobTwo.png','src/assets/umoobThree.png'],
